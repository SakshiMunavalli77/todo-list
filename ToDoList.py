...
if __name__ == "__main__" :
    ...
    gui.title("ToDo List Application")
 
    #set the configuration of GUI window 
    gui.geometry("260x420")
    ...
    #create a Submit Button and place into the root window when user press the button, the command or function affiliated to that button is executed 
    Submit = Button(gui, text = "Submit", fg = "Black", bg = "tomato", command = insertTask, pady = 5)
 
    #create a text area for the root with lunida 13 font text area is for writing the content
    TextArea = Text(gui, height = 10, width = 25, font = "lucida 13", pady = 5)
 
    #create a label : Delete Task Number
    taskNumber = Label(gui, text = "Delete Task Number", bg = "skyblue")
                        
    taskNumberField = Text(gui, height = 1, width = 2, font = "lucida 13")
 
    #create a Delete Button and place into the root window when user press the button, the command or function affiliated to that button is executed .
    delete = Button(gui, text = "Delete", fg = "Black", bg = "tomato", command = delete, pady = 5)
 
    #create a Exit Button and place into the root window when user press the button, the command or function affiliated to that button is executed .
    Exit = Button(gui, text = "Exit", fg = "Black", bg = "tomato", command = exit, pady = 5)
